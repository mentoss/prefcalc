           ...
           <tbody><tr>
               <td>
                   <h4>Бланк пули на четверых</h4>
                    <p><a class="btn btn-default" href="#"><i class="fa fa-download"></i> Скачать</a>
        ...
        <table class="table">
            ...
            <tbody>
               <tr>
                    ...
                    <td><input type="text" name="heap_player-4" placeholder="Гора"></td>
                </tr>
                <tr>
                    <td><b>Пуля</b></td>
                    ...
                    <td><input type="text" name="pool_player-4" placeholder="Пуля"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="plr-1_whists-on-plr-4" placeholder="Висты на игрока 4"></td>
                </tr>
                <tr>
                   <td><b>Игрок 2</b></td>
                    ...
                    <td><input type="text" name="plr-2_whists-on-plr-4" placeholder="Висты на игрока 4"></td>
                </tr>
                <tr>
                   <td><b>Игрок 3</b></td>
                    ...
                    <td class="disabled text-center"><i class="fa fa-times"></i></td>
                    <td><input type="text" name="plr-3_whists-on-plr-4" placeholder="Висты на игрока 4"></td>
                </tr>
                <tr>
                   <td><b>Игрок 4</b></td>
                    <td><input type="text" name="plr-4_whists-on-plr-1" placeholder="Висты на игрока 1"></td>
                    <td><input type="text" name="plr-4_whists-on-plr-2" placeholder="Висты на игрока 2"></td>
                    <td><input type="text" name="plr-4_whists-on-plr-3" placeholder="Висты на игрока 3"></td>
                    <td class="disabled text-center"><i class="fa fa-times"></i></td>
                </tr>
               ...
               <tr class="total">
                    ...
                    <td><span class="text-red">- 221</span></td>
                </tr>
            </tbody>
            <tfoot>
                <tr>
