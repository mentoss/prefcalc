    ...
    <form method="post" action="" class="calculate-form">
                ...
                <td>
                    ...
                    <div class="radio">
                        ...
                        <div class="checkbox">
                            ...
                            <label>
                                <input type="radio" name="optionsDivided" value="option2" > 2
                            </label>

                            <label>
                                <input type="radio" name="optionsDivided" value="option3" > 3
                            </label>
                        </div>
        ...
        <table class="table-calc table table-bordered">
            ...
            <tbody>
               <tr>
                    <td><b>Гора</b></td>
                    <td><input type="text" class="form-control" name="heap_player-1" placeholder="Гора"></td>
                    <td><input type="text" class="form-control" name="heap_player-2" placeholder="Гора"></td>
                    <td><input type="text" class="form-control" name="heap_player-3" placeholder="Гора"></td>                                            
                </tr>
                <tr>
                    <td><b>Пуля</b></td>
                    <td><input type="text" class="form-control" name="pool_player-1" placeholder="Пуля"></td>
                    <td><input type="text" class="form-control" name="pool_player-2" placeholder="Пуля"></td>
                    <td><input type="text" class="form-control" name="pool_player-3" placeholder="Пуля"></td>                                            
                </tr>
               <tr class="active">
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control" name="plr-1_whists-on-plr-2" placeholder="Висты на игрока 2"></td>
                    <td><input type="text" class="form-control" name="plr-1_whists-on-plr-3" placeholder="Висты на игрока 3"></td>                                            
                </tr>
                <tr>
                   <td><b>Игрок 2</b></td>                                            
                    <td><input type="text" class="form-control" name="plr-2_whists-on-plr-1" placeholder="Висты на игрока 1"></td>
                    <td class="disabled text-center text-danger"><i class="fa fa-times"></i></td>
                    <td><input type="text" class="form-control" name="plr-2_whists-on-plr-3" placeholder="Висты на игрока 3"></td>                                            
                </tr>
                <tr>                      
                   <td><b>Игрок 3</b></td>                     
                    <td><input type="text" class="form-control" name="plr-3_whists-on-plr-1" placeholder="Висты на игрока 1"></td>
                    <td><input type="text" class="form-control" name="plr-3_whists-on-plr-2" placeholder="Висты на игрока 2"></td>
                    <td class="disabled text-center text-danger"><i class="fa fa-times"></i></td>
                </tr>
